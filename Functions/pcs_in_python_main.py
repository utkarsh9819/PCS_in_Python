...
def matrix_manipulation (data):
  ...
  """
    ...
    This function manipulates a dataset as provided in the repo so as to create an interconnection matrix which can be fed into the PCS Model. It feeds the
